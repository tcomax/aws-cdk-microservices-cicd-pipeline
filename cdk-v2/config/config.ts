    ...
    [
        {
            ...
            serviceSubnets: ['subnet-xxxxxxxxxxxxxxxxxxxx', 'subnet-yyyyyyyyyyyyyyyyyyyyyy'],
            ...
            fargateService: {
                serviceName: 'sampleApiAuthenticationApi',
                desiredCount: 1,
        ...
        },
        {
            ...
            githubRepository: {
                type: "String",
                description: "sample merchant Service API - Github source code repository",
